...
//                         charAt(o) + this._keyStr.charAt(u) + this._keyStr.charAt(a)
//                     }
//                     return t
//                 },
//                 decode: function(e) {
...
//         $http({
//                 method: "GET",
//                 url: '/rest/api/weather/' + $scope.city,
//                 headers: {
//                     'Authorization': 'Basic ' + sharedProperties.getEncodedAuth()
//                 }
//             }).success(function(data, status, headers, config) {
//                 $scope.temp = data;
...
//                 url: '/rest/api/weather/' + $scope.city,
//                 headers: {
//                     'Authorization': 'Bearer ' + sharedProperties.getOauthToken()
//                 }
//             }).success(function(data, status, headers, config) {
//                 $scope.temp = data;
//                 $scope.myCity = $scope.city;
